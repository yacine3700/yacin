...
def api1(ids,names,passlist):
        try:
            ...
            for pw in passlist:
                ...
                ua_string = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/FB4A;FBAV/199.39.69.33;FBBV/80256214;FBDM/{density=2.7,width=990,height=2526};FBLC/en_US;FBRV/11808825;FBCR/null;FBMF/lge;FBBD/lge;FBPN/com.facebook.katana;FBDV/LGE;FBSV/4.3;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
                li = ['28','29','210']
